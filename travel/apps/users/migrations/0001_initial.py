# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-04-21 16:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('0', '公开'), ('1', '默认')], default=0, max_length=2, verbose_name='设为默认联系人')),
                ('user_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '常用出行人',
                'verbose_name_plural': '常用出行人',
            },
        ),
    ]
